...
<#elseif screen.action == "createLitter">
	...
	<div style="clear:both; display:block">
		<label style="width:16em;float:left;" for="littergeneration">Litter generation:</label>
	...
	<div style="clear:both; display:block">
		<label style="width:16em;float:left;" for="litterbreedigcageid">Breeding Cage Id:</label>
...
<#elseif screen.action == "GenotypeLitter">
	...
	${screen.getEditTable()}
		...
		<div style="float:left">
			<input type='submit' id='go_back' value='Cancel' onclick="__action.value='switchLitter'" />
		</div>
