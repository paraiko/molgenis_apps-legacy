...
public class Breedingnew extends PluginModel<Entity>
{
			...
			String remarks) throws Exception
	{
		...
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null, "SetTypeOfGroup",
				"TypeOfGroup", groupName, "Parentgroup", null));
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null, "SetLine", "Line",
				groupName, null, line));
		// add security measurements
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null,
				"SetIsWritableByMolgenisRole", "IsWritableByMolgenisRole", groupName, "admin", null));
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null,
				"SetIsWritableByMolgenisRole", "IsWritableByMolgenisRole", groupName, "Caretakers", null));
		...
		// Set start date
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null, "SetStartDate",
				"StartDate", groupName, dbFormat.format(eventDate), null));
		// Set remarks
		if (remarks != null)
		{
			valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null, "SetRemark",
					"Remark", groupName, remarks, null));
		}

		// Add Set Active, with (start)time = entrydate and endtime = null
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null, "SetActive", "Active",
	...
	private String ApplyAddLitter(Database db, Tuple request) throws Exception
	{
		...
		// add security measurements
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null,
				"SetIsWritableByMolgenisRole", "IsWritableByMolgenisRole", litterName, "admin", null));
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null,
				"SetIsWritableByMolgenisRole", "IsWritableByMolgenisRole", litterName, "Caretakers", null));
		valuesToAddList.add(ct.createObservedValueWithProtocolApplication(invName, now, null,
				"SetIsWritableByMolgenisRole", "IsWritableByMolgenisRole", litterName, "panel_" + line, null));
